...
\noindent\fbox{%
    ...
    \textbf{Problem:} Key sizes are $\approx$ 0.9 GB under toy params and $\approx$ 30 GB under secure. 
...
\textit{Solution process:} Trimming rotation keys. 
Future step to consider taking: seeded keys so that the upload is small (at the cost of having to recover the keys server-side afterwards).
